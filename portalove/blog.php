...
$clanky = $db->getArticles("3");




$clanok = $db->getArticle($id);
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 col-xl-9">
                        <div class="tm-blog-post">
                            <?php foreach($clanok as $clanok){?>
                            <h3 class="tm-gold-text"><?php echo $clanok["nadpis"];?></h3>
                            <p>Vivamus accumsan blandit ligula. Sed lobortis efficitur sapien</p>
                            <img src="img/<?php echo $clanok["titulka"];?>" alt="Image" class="img-fluid tm-img-post">
                            
                            <?php echo $clanok["clanok"];?>
                        </div>
                    <?php } ?>
                    <br>
